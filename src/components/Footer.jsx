            ...
            <div className="section-container">
                <div className="footer-name">
                    <h2 className="footer-heading">
                        HUSNAIN <span className="serif-accent">Faisal</span>
                    </h2>
                </div>

                <div className="footer-social">
                    <p className="footer-social-label">Find Me Online</p>
                ...
                <div className="footer-bottom">
                    <p className="footer-copyright">
                        © 2025 Husnain Faisal. ARCHITECTURAL INTEGRITY SECURED. ALL SYSTEMS NOMINAL.
                    </p>
                </div>
            </div>
        </footer>
